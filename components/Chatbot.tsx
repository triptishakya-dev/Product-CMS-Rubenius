...
const Chatbot = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[100] flex flex-col items-end">
      {/* Chat Window */}
      {isOpen && (
        <div className="mb-4 w-[350px] md:w-[400px] h-[500px] bg-white rounded-[32px] shadow-2xl border border-gray-100 flex flex-col overflow-hidden animate-in slide-in-from-bottom-8 fade-in duration-500">
          {/* Header */}
          <div className="bg-black p-6 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-white font-black text-sm uppercase tracking-widest">Reminious AI</h3>
            ...
            <div className="flex gap-3">
              ...
              <div className="space-y-3">
                <div className="bg-white p-4 rounded-2xl rounded-tl-none border border-gray-100 shadow-sm text-sm font-medium text-black leading-relaxed">
                  Greetings! I am <span className="font-bold">Reminious</span>, your dedicated concierge for the Rubenix ecosystem. How may I assist your journey today?
                </div>
          ...
          <div className="p-6 bg-white border-t border-gray-100">
            <div className="relative flex items-center gap-2">
              ...
              <Button 
                size="icon" 
                className="absolute right-1.5 h-9 w-9 bg-black text-white rounded-xl hover:bg-gray-800 transition-all active:scale-90"
              >
